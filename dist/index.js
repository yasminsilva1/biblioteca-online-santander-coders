...
class Menu {
    ...
    listarLivros() {
        this.biblioteca.listarItens().filter((item) => item instanceof Livro_1.Livro).forEach((item) => console.log(item.getInfo()));
    }
    listarRevistas() {
        this.biblioteca.listarItens().filter((item) => item instanceof Revista_1.Revista).forEach((item) => console.log(item.getInfo()));
    }
    listarCDs() {
        this.biblioteca.listarItens().filter((item) => item instanceof CD_1.CD).forEach((item) => console.log(item.getInfo()));
    }
    listarDVDs() {
        this.biblioteca.listarItens().filter((item) => item instanceof DVD_1.DVD).forEach((item) => console.log(item.getInfo()));
    }
    listarTodosItens() {
        this.biblioteca.listarItens().forEach((item) => console.log(item.getInfo()));
    }
    removerLivro() {
    ...
    removerTodosItens() {
        this.biblioteca.listarItens().forEach((item) => this.biblioteca.removerItem(item.id));
    ...
    editarLivro() {
        ...
        const livro = this.biblioteca.listarItens().find((item) => item.id === id && item instanceof Livro_1.Livro);
        if (livro) {
    ...
    editarRevista() {
        ...
        const revista = this.biblioteca.listarItens().find((item) => item.id === id && item instanceof Revista_1.Revista);
        if (revista) {
    ...
    editarCD() {
        ...
        const cd = this.biblioteca.listarItens().find((item) => item.id === id && item instanceof CD_1.CD);
        if (cd) {
    ...
    editarDVD() {
        ...
        const dvd = this.biblioteca.listarItens().find((item) => item.id === id && item instanceof DVD_1.DVD);
        if (dvd) {
