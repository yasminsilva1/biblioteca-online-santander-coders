...
class Menu {
    ...
    private listarLivros() {
        this.biblioteca.listarItens().filter((item: ItemAcervo) => item instanceof Livro).forEach((item: ItemAcervo) => console.log(item.getInfo()));
    }

    private listarRevistas() {
        this.biblioteca.listarItens().filter((item: ItemAcervo) => item instanceof Revista).forEach((item: ItemAcervo) => console.log(item.getInfo()));
    }

    private listarCDs() {
        this.biblioteca.listarItens().filter((item: ItemAcervo) => item instanceof CD).forEach((item: ItemAcervo) => console.log(item.getInfo()));
    }

    private listarDVDs() {
        this.biblioteca.listarItens().filter((item: ItemAcervo) => item instanceof DVD).forEach((item: ItemAcervo) => console.log(item.getInfo()));
    }

    private listarTodosItens() {
        this.biblioteca.listarItens().forEach((item: ItemAcervo) => console.log(item.getInfo()));
    }
    ...
    private removerTodosItens() {
        this.biblioteca.listarItens().forEach((item: ItemAcervo) => this.biblioteca.removerItem(item.id));
        console.log('Todos os itens foram removidos com sucesso!');
    }

    private editarLivro() {
        const id = parseInt(readlineSync.question('ID do livro a ser editado: '));
        const livro = this.biblioteca.listarItens().find((item: ItemAcervo) => item.id === id && item instanceof Livro) as Livro;
        if (livro) {
    ...
    private editarRevista() {
        ...
        const revista = this.biblioteca.listarItens().find((item: ItemAcervo) => item.id === id && item instanceof Revista) as Revista;
        if (revista) {
    ...
    private editarCD() {
        ...
        const cd = this.biblioteca.listarItens().find((item: ItemAcervo) => item.id === id && item instanceof CD) as CD;
        if (cd) {
    ...
    private editarDVD() {
        ...
        const dvd = this.biblioteca.listarItens().find((item: ItemAcervo) => item.id === id && item instanceof DVD) as DVD;
        if (dvd) {
